...
export default function HeroSection({
  ...
  const mailHref = contactEmail ? `mailto:${contactEmail}` : 'mailto:hello@example.com'
        ...
        <div className="grid flex-1 grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-x-20 lg:gap-y-0">
          <div className="order-2 flex flex-col items-center text-center lg:order-1 lg:items-start lg:text-left">
            ...
            <div className="mt-8 flex justify-center gap-3 lg:justify-start">
              ...
              <SocialIconButton href={mailHref} label="Email">
          ...
          <div className="order-1 flex justify-center lg:order-2 lg:justify-end lg:pl-4">
            <div className="group relative">
              {imageUrl ? (
                <img
                  src={proxiedMediaSrc(imageUrl)}
                  alt={imageAlt || ''}
                  className="h-72 w-72 rounded-full border-4 border-[color:var(--border-strong)] object-cover shadow-2xl transition duration-300 group-hover:scale-[1.02] sm:h-80 sm:w-80 lg:h-96 lg:w-96"
                />
              ) : (
